const { signupParticipant, activateParticipant, signinParticipant, getAllEvents, getAllOrders, getOneEvent } = require('../../../services/mongoose/participants');
...
module.exports = { signup, activeParticipant, signin, getAllLandingPage, getDashboard, getDetailLandingPage };
